(function () {
  ...
  const terms = {
    en: {
      ...
      tag: { concept: 'concept', portrait: 'portrait', 'x-twitter': 'x-twitter', cityscape: 'cityscape', vibrant: 'vibrant', sunset: 'sunset', scene: 'scene', enchanted: 'enchanted', forest: 'forest', pathway: 'pathway' }
    },
    zh: {
      ...
      tag: { concept: '概念', portrait: '人像', 'x-twitter': 'X/Twitter', cityscape: '城市景观', vibrant: '鲜艳', sunset: '日落', scene: '场景', enchanted: '魔法', forest: '森林', pathway: '小径' }
    }
  };
