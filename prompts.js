...
window.PROMPTS = [
  ...
  },
  {
    ...
    "prompt": "Images suitable for PPT, infographics, self-media covers, knowledge cards, business cards, or brand visuals. For detailed prompts, see the original source link.",
    "promptZh": "适用于 PPT、信息图、自媒体封面、知识卡片、名片或品牌视觉的图片。提示词详见原始来源链接。"
  },
  {
